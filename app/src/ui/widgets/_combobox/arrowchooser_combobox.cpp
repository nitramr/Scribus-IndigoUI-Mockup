...
*/
#include "arrowchooser_combobox.h"
...
ArrowChooserComboBox::ArrowChooserComboBox(QWidget* pa, ArrowDirection direction) : QComboBox(pa)
{
    setEditable(false);
    clear();
...
void ArrowChooserComboBox::setArrowDirection(ArrowDirection direction)
{
    m_arrowDirection = direction;
}

void ArrowChooserComboBox::rebuildList(QList<ArrowDesc> *arrowStyles)
{
    FPointArray path;
...
//		painter->clear();
        ...
        painter->setPen(QPen(textColor, 1, Qt::SolidLine, Qt::FlatCap, Qt::MiterJoin));
        //painter->setFillMode(QPainter::Solid);
...
//void ComboBoxArrowChooser::rebuildList(QList<ArrowDesc> *arrowStyles)
//{
//    FPointArray path;
