...
class SCRIBUS_API ComboBoxArrowChooser : public QComboBox
{
    Q_OBJECT

public:
    ComboBoxArrowChooser(QWidget* pa, ArrowDirection direction = ArrowDirection::StartArrow);
    ~ComboBoxArrowChooser() {};
