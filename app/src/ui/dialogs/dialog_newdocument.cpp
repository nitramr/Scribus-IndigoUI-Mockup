...
DialogNewDocument::DialogNewDocument(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::DialogNewDocument)
{
    ui->setupUi(this);
...
DialogNewDocument::~DialogNewDocument()
{
    delete ui;
}

void DialogNewDocument::setup()
{
...
void DialogNewDocument::connectSlots()
{
    connect(ui->listDocumentTypes, &QListWidget::itemSelectionChanged, this, &DialogNewDocument::changedPageLayout);
}
...
void DialogNewDocument::dummyContent()
{
...
void DialogNewDocument::changedPageLayout()
{
