...
ComboBoxLineType::ComboBoxLineType(QWidget* pa) : QComboBox(pa)
{
    setEditable(false);
...
void ComboBoxLineType::changeEvent(QEvent *e)
{
...
void ComboBoxLineType::styleChange()
{
...
void ComboBoxLineType::themeChange()
{
    styleChange();
}

void ComboBoxLineType::updateList()
{
    for (int i = 0; i < 37; i++)
        addItem(QIcon(createIcon(i)), QString());
}

QPixmap ComboBoxLineType::createIcon(int type)
{
    QPen pen;
