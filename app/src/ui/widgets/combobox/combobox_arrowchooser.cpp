...
*/
#include "combobox_arrowchooser.h"
...
ComboBoxArrowChooser::ComboBoxArrowChooser(QWidget* pa, ArrowDirection direction) : QComboBox(pa)
{
    setEditable(false);
    clear();
...
void ComboBoxArrowChooser::setArrowDirection(ArrowDirection direction)
{
